  ...
  return (
    <>
      <div className="m-12 mt-[11.2rem]">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center md:ml-32 md:mr-32">
          <img
            src="./assets/images/mission.webp"
            alt=""
            className="m-6 w-full md:w-[45%]"
          />
          <div className="m-6 md:pl-4 w-full md:w-[50%] text-center grid place-items-center">
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-center md:ml-32 md:mr-32">
          <div className="m-6 md:pl-4 w-full md:w-[50%] text-center grid place-items-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center md:ml-32 md:mr-32">
          ...
          <div className="m-6 md:pl-4 w-full md:w-[50%] text-center grid place-items-center">
            ...
            <ul className="text-tgray font-playfair list-disc relative w-36">
              <li><a href="" className="block md:absolute pl-4 left-0">Customer Focus</a></li>
              <li><a href="" className="block md:absolute pl-4 left-0 ">Trust</a></li>
              <li><a href="" className="block md:absolute pl-4 left-0 ">Agility</a></li>
            </ul>
          </div>
        </div>
      </div>
